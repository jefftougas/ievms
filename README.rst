...
* Install IE versions 7, 8 and 9 - no support for IE6 currently
    ...
    curl -s https://raw.github.com/jefftougas/ievms/master/ievms.sh | bash

* Install specific IE versions (IE7 and IE9 only for example):

    curl -s https://raw.github.com/jefftougas/ievms/master/ievms.sh | IEVMS_VERSIONS="7 9" bash
...
To specify where the VMs are installed, use the INSTALL_PATH variable:
    ...
    curl -s https://raw.github.com/jefftougas/ievms/master/ievms.sh | INSTALL_PATH="/Path/to/.ievms" bash
